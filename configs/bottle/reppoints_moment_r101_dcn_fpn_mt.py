...
data = dict(
    ...
    test=dict(
        ...
        pipeline=test_pipeline))
# optimizer
optimizer = dict(type='SGD', lr=0.005/8 * 2, momentum=0.9, weight_decay=0.0001)
...
log_level = 'INFO'
work_dir = './work_dirs_bottle/reppoints_moment_r101_dcn_fpn_mt/checkpoints/'
load_from = None
load_from = work_dir+'reppoints_moment_r101_dcn_fpn_2x_mt.pth'
resume_from = None
auto_resume = True
workflow = [('train', 1)]
