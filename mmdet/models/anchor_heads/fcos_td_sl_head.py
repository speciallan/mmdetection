...
class FCOSTDSLHead(nn.Module):
    ...
    def __init__(self,
        ...
        super(FCOSTDSLHead, self).__init__()
    ...
    def _init_layers(self):
        ...
        # 场景分支
        self.fcos_scene = nn.Conv2d(self.feat_channels, self.scene_out_channels, 3, padding=1)
        self.fcos_scene_post = nn.Conv2d(self.scene_out_channels, self.feat_channels, 3, padding=1)
        # 原图大小二值图
    ...
    def init_weights(self):
        ...
        normal_init(self.fcos_scene, std=0.01)
    ...
    def forward_single(self, x, scale):
        ...
        # 经过rpn处理后的特征 像素级加权 + 跳接，rpn回归特征复用，系数alpha
        alpha = 1.0
        cls_feat = x * rpn_cls_probs * alpha
        cls_feat = x + cls_feat # 跳接 被增强的前景特征
        scene_feat = x - cls_feat # 被抑制的场景特征
