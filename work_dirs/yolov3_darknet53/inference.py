...
result_path = '../../data/VOCdevkit/SAR-Ship-Dataset/results/fcos_td_x101_caffe_fpn/'
config_file = 'configs/my/fcos_td_x101_caffe_fpn.py'
checkpoint_file = 'work_dirs/fcos_td_x101_caffe_fpn/checkpoints/latest.pth'
