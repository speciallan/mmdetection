...
result_path = '../../data/VOCdevkit/SAR-Ship-Dataset/results/retinanet_x101_32x4d_fpn_1x/'
config_file = 'configs/retinanet_x101_32x4d_fpn_1x.py'
checkpoint_file = 'work_dirs/retinanet_x101_32x4d_fpn_1x/checkpoints/latest.pth'
